from Factories.JungleGenerator import JungleGenerator
import sys
import cv2
import numpy as np
...
if __name__ == '__main__':
    ...
    # create level generator object
    world_generator = JungleGenerator()

    # create world objects
    plant = world_generator.create_plant()
    animal = world_generator.create_animal()
    ground = world_generator.create_ground()
